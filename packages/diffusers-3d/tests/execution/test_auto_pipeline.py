    ...
    assert snapshot_calls == [
        {
            ...
            "allow_patterns": [
                ...
                "variant/mesh_decoder/*.json",
                "variant/mesh_decoder/*.safetensors",
                "variant/mesh_decoder/*.flashpack",
                "variant/radiance_field_decoder/*.json",
                "variant/radiance_field_decoder/*.safetensors",
                "variant/radiance_field_decoder/*.flashpack",
